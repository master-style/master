    ...
    protected toggling(
        ...
        if (this.placement === 'origin' && this.trigger) {
            ...
            const
                ...
                rootRect = this.main.getBoundingClientRect();
            ...
            if (!this.placement || this.placement === 'origin') {
                ...
                switch (this.placement) {
                    case 'right':
                        ...
                        offset = '100%';
                        if (this.pushing)
                            pushingOffset = -this.main.offsetWidth / 3;
                        break;
                    case 'left':
                        dir = 'X';
                        offset = '-100%';
                    ...
                    case 'bottom':
                        ...
                        offset = '100%';
                        if (this.pushing)
                            pushingOffset = -this.main.offsetHeight / 3;
                        break;
                    case 'top':
                        dir = 'Y';
                        offset = '-100%';
        ...
        this.animation = this.main.animate(keyframes, options);
        ...
        return new Promise<void>((finish) => {
            this.animation.onfinish = () => {
                ...
                if (content) {
                    if (hidden) {
                        enableBodyScroll(content.main);
                    } else {
                        disableBodyScroll(content.main);
                        content.enable();
                    }
                }
                finish();
